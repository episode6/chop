...
##How do I set it up?
- Add maven/gradle dependency on `com.episode6.hackit.chop:chop-core:0.1.7.3-SNAPSHOT`
- If you're building an android project, also add `com.episode6.hackit.chop:chop-android:0.1.7.3-SNAPSHOT`
